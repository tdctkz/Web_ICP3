...
function win(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". YOU WIN! Wan't to Play again.";

}

function lose(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". YOU LOST AND COMPUTER WIN! Wan't to Play Again.";
}

function draw(userOption, computerOption) {
    document.querySelector(".results>p").innerHTML = " Your choice is: " + convertToWord(userOption) + ". Computer choice is: " + convertToWord(computerOption) + ". IT'S A DRAW! Wan't to Play Again.";
}
